...
local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/odhdshhe/cinui/refs/heads/main/lengui%20(1).lua"))()        
...
local UITab79 = window:Tab("霖溺汉化阿尔宙斯脚本",'17860099393')
